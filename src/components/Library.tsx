...
const TOPICS = [
  {
    ...
    xp: 20,
    docs: [
      { title: "Приказ Минтруда №903н от 15.12.2020 (ред. от 29.04.2025) — ПОТЭЭ", clause: "п. 3.3, Приложение №1" },
      { title: "Приказ Минэнерго №811 от 12.08.2022 — ПТЭЭП", clause: "Приложение №1" },
      { title: "Приказ Минтруда №287н от 29.04.2025 — Формы удостоверений по электробезопасности", clause: "Приложения №1–5" },
    ],
...
**V группа** — право на все виды работ, включая руководство бригадами в установках выше 1000 В. Стаж с IV группой не менее 3 месяцев.`,
  },
  {
    ...
    xp: 20,
    docs: [
      { title: "Приказ Минтруда №903н от 15.12.2020 (ред. от 29.04.2025) — ПОТЭЭ", clause: "п. 13–19" },
      { title: "Приказ Минэнерго №261 от 30.06.2003 — Инструкция по применению и испытанию СЗ", clause: "разд. 1–2" },
      { title: "ГОСТ Р 12.4.026-2015 — Цвета сигнальные, знаки безопасности", clause: "разд. 4" },
    ],
...
**Важно:** все СИЗ должны проходить периодические электрические испытания. Использование просроченных СИЗ запрещено.`,
  },
  {
    ...
    xp: 20,
    docs: [
      { title: "Приказ Минтруда №903н от 15.12.2020 (ред. от 29.04.2025) — ПОТЭЭ", clause: "п. 5.1–5.30" },
      { title: "Приказ Минэнерго №811 от 12.08.2022 — ПТЭЭП", clause: "п. 1.4.1–1.4.10" },
    ],
...
Наряд выдаётся на срок не более 15 календарных дней. Продление возможно, но не более одного раза.`,
  },
  {
    ...
    xp: 20,
    docs: [
      { title: "Приказ Минтруда №903н от 15.12.2020 (ред. от 29.04.2025) — ПОТЭЭ", clause: "п. 89–91, Приложение №6" },
      { title: "Постановление Правительства РФ №2464 от 24.12.2021 — Порядок обучения по ОТ", clause: "п. 46–48" },
...
**Важно:** даже если пострадавший чувствует себя хорошо — госпитализация обязательна, так как последствия могут проявиться позже.`,
  },
  {
    ...
    xp: 20,
    docs: [
      { title: "Приказ Минтруда №903н от 15.12.2020 (ред. от 29.04.2025) — ПОТЭЭ", clause: "Приложение №8" },
      { title: "ГОСТ Р 12.4.026-2015 — Цвета сигнальные, знаки и разметка безопасности", clause: "п. 6.1–6.4" },
    ],
...
Плакаты устанавливаются перед началом работы и снимаются только после её окончания.`,
  },
  {
    ...
    xp: 20,
    docs: [
      { title: "ПУЭ 7-е издание (утв. Приказом Минэнерго №204 от 08.07.2002)", clause: "п. 1.7.1–1.7.3" },
      { title: "ГОСТ Р МЭК 60479-1-2009 — Воздействие тока на человека и животных", clause: "разд. 4–5" },
      { title: "Приказ Минтруда №903н от 15.12.2020 (ред. от 29.04.2025) — ПОТЭЭ", clause: "Приложение №6" },
    ],
        ...
        {topic.docs.map((doc, i) => (
          <div key={i} className="flex items-start gap-2 text-xs text-gray-400">
            ...
            <span>
              ...
              {" — "}
              <span className="text-yellow-500 font-semibold">{doc.clause}</span>
            </span>
          </div>
        ))}
      </div>
