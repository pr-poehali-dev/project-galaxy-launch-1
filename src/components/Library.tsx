...
const TOPICS = [
  {
    ...
    xp: 20,
    docs: [
      { title: "Приказ Минтруда №903н (Правила по охране труда при эксплуатации электроустановок)", clause: "п. 3.3, Приложение №1" },
...
**V группа** — право на все виды работ, включая руководство бригадами в установках выше 1000 В. Стаж с IV группой не менее 3 месяцев.`,
  },
  {
    ...
    xp: 20,
    docs: [
      { title: "Приказ Минтруда №903н (Правила по охране труда при эксплуатации электроустановок)", clause: "п. 13–19" },
      { title: "Инструкция по применению и испытанию средств защиты (Приказ Минэнерго №184)", clause: "разд. 1–2" },
      { title: "ГОСТ Р 12.4.234-2012 (Средства защиты от электрического тока)", clause: "разд. 4" },
    ],
...
**Важно:** все СИЗ должны проходить периодические электрические испытания. Использование просроченных СИЗ запрещено.`,
  },
  {
    ...
    xp: 20,
    docs: [
      { title: "Приказ Минтруда №903н (Правила по охране труда при эксплуатации электроустановок)", clause: "п. 5.1–5.30" },
      { title: "Приказ Минэнерго №6 (ПТЭЭП)", clause: "п. 1.4.1–1.4.10" },
    ],
...
Наряд выдаётся на срок не более 15 календарных дней. Продление возможно, но не более одного раза.`,
  },
  {
    ...
    xp: 20,
    docs: [
      { title: "Приказ Минтруда №903н (Правила по охране труда при эксплуатации электроустановок)", clause: "п. 89–91, Приложение №6" },
      { title: "Постановление Правительства РФ №2464 (Порядок обучения по охране труда)", clause: "п. 46–48" },
...
**Важно:** даже если пострадавший чувствует себя хорошо — госпитализация обязательна, так как последствия могут проявиться позже.`,
  },
  {
    ...
    docs: [
      ...
      { title: "ГОСТ Р 12.4.026-2015 (Цвета сигнальные, знаки безопасности)", clause: "п. 6.1–6.4" },
    ],
...
Плакаты устанавливаются перед началом работы и снимаются только после её окончания.`,
  },
  {
    ...
    xp: 20,
    docs: [
      { title: "ПУЭ (Правила устройства электроустановок), 7-е изд.", clause: "п. 1.7.1–1.7.3" },
      { title: "ГОСТ Р МЭК 60479-1-2009 (Воздействие тока на человека и животных)", clause: "разд. 4–5" },
      { title: "Приказ Минтруда №903н", clause: "Приложение №6" },
    ],
