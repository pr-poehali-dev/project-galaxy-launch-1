...
const questions = [
  ...
  },
  {
    ...
    docs: [
      { title: "ПУЭ 7-е издание (утв. Приказом Минэнерго №204 от 08.07.2002)", clause: "п. 1.1.29" },
      { title: "ГОСТ IEC 60446-2015 — Маркировка проводников цветами и цифрами", clause: "п. 5.3" },
    ],
  },
  {
    ...
    docs: [
      { title: "Постановление Правительства РФ №2464 от 24.12.2021 — Порядок обучения по ОТ", clause: "п. 16" },
      { title: "Приказ Минтруда №903н от 15.12.2020 (ред. от 29.04.2025) — ПОТЭЭ", clause: "п. 2.4" },
    ],
  },
  {
  ...
  },
  {
    ...
    docs: [
      { title: "Приказ Минтруда №903н от 15.12.2020 (ред. от 29.04.2025) — ПОТЭЭ", clause: "п. 44.6" },
      { title: "ПУЭ 7-е издание (утв. Приказом Минэнерго №204 от 08.07.2002)", clause: "п. 1.7.46" },
    ],
  },
  {
    ...
    docs: [
      { title: "Приказ Минтруда №903н от 15.12.2020 (ред. от 29.04.2025) — ПОТЭЭ", clause: "п. 5.15" },
      { title: "Приказ Минэнерго №811 от 12.08.2022 — ПТЭЭП", clause: "п. 1.4.6" },
    ],
  },
]
